...
public class input extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        glob.inp -= nn;
        //minutes
        nn=(int)(Math.floor(10*glob.inp));
        glob.car[3] = nn;

        inputview = new inputdraw(this);
            ...
            switch(ev.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if ((y1>wy*0.7)&&(y2>wy*0.7)&&(x1>cx-40)&&(x2<cx+40)) {
                        ...
                        glob.inp =  glob.sign * (float) ((10*glob.car[0])+(glob.car[1])+(0.1666666667*glob.car[2])+(0.01666666667*glob.car[3]));
                        finish();
                    }
